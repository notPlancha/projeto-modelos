...
```{r}
#fit 1
MAPE(fit1$fitted.values, dfAll$price) # in-sample
```
...
```{r}
#fit 4
MAPE(fit4$fitted.values, dfAll$price) # in-sample
```

```{r}
#fit 5
MAPE(fit5$fitted.values, dfAll$price) # in-sample
```

```{r}
#fit 6
MAPE(fit6$fitted.values, dfAll$price) # in-sample
```

```{r}
#fit 7
MAPE(fit7$fitted.values, dfAll$price) # in-sample
```
