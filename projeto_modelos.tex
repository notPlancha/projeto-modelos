...
\hlstd{df} \hlopt{%>%}
    \hlkwd{ggplot}\hlstd{(}\hlkwd{aes}\hlstd{(}\hlkwc{y} \hlstd{= price,}
        \hlkwc{x} \hlstd{=} \hlkwd{fct_reorder}\hlstd{(neighbourhood,}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: Discrete value supplied to continuous scale}}\end{kframe}
\end{knitrout}
