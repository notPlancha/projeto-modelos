...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file 'C:/Users/tomas/Documents/projeto-modelos/listings.csv': No such file or directory}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.data.frame(x): object 'listings' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(listings, aes(x = price)): object 'listings' not found}}\end{kframe}
\end{knitrout}
